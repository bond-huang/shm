<template>
  <div class="shm-aside" :class="{ collapsed: isCollapse }">
    ...
    >
      ...
      <el-menu-item index="3" @click="openPage('/ai-assistant')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon">
          <path d="M12 2a4 4 0 0 1 4 4v1a4 4 0 0 1-8 0V6a4 4 0 0 1 4-4z"/><path d="M9 14h6"/><path d="M10 18h4"/><path d="M8 22h8"/><circle cx="9" cy="9" r="1" fill="currentColor"/><circle cx="15" cy="9" r="1" fill="currentColor"/>
        </svg>
        <span class="menu-text">AI Assistant</span>
      </el-menu-item>

      <el-submenu index="4" popper-class="aside-submenu-popup">
        <template #title>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon">
            <line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/>
          </svg>
          <span class="menu-text">Analytical Tool</span>
        </template>
        <el-menu-item-group>
          <el-menu-item index="4-1" @click="openPage('/analytical-tools')">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon-sm">
              <rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/>
            </svg>
            <span class="menu-text">All Tool</span>
          </el-menu-item>
          <el-menu-item index="4-2" @click="openPage('/tool-class')">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon-sm">
              <line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/>
            </svg>
            <span class="menu-text">Tool Class</span>
          </el-menu-item>
        </el-menu-item-group>
      </el-submenu>

      <el-submenu index="5" popper-class="aside-submenu-popup">
        <template #title>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon">
            <polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/>
          </svg>
          <span class="menu-text">Script Library</span>
        </template>
        <el-menu-item-group>
          <el-menu-item index="5-1" @click="openPage('/script-library')">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon-sm">
              <rect x="3" y="3" width="18" height="18" rx="2"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="14" y2="12"/><line x1="8" y1="16" x2="12" y2="16"/>
            </svg>
            <span class="menu-text">All Scripts</span>
          </el-menu-item>
          <el-menu-item index="5-2" @click="openPage('/script-class')">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon-sm">
              <line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/>
            </svg>
            <span class="menu-text">Script Class</span>
          </el-menu-item>
        </el-menu-item-group>
      </el-submenu>

      <el-submenu index="6" popper-class="aside-submenu-popup">
        <template #title>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon">
        ...
        <el-menu-item-group>
          <el-menu-item index="6-1" @click="openPage('/user-settings')">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="menu-icon-sm">
